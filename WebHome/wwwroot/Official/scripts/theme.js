	...
	*/
	if( $('.thumb-info-floating-element-wrapper').length ) {
		...
		if (typeof gsap !== 'undefined') {
			...
			theme.fn.showErrorMessage('Failed to Load File', 'Failed to load: GSAP - Include the following file(s): (plugins/gsap/gsap.min.js)');
		}
...
(function(theme, $) {
	...
	PluginRevolutionSlider.defaults = {
	    ...
	    whiteboard: {
	        movehand: {
	            src: '../plugins/rs-plugin/revolution-addons/whiteboard/assets/images/hand_point_right.png',
	            width: 400,
	            height: 1000,
	            handtype: 'right',
	            transform: {
	        ...
	        writehand: {
	            src: '../plugins/rs-plugin/revolution-addons/whiteboard/assets/images/write_right_angle.png',
	            width: 572,
	            height: 691,
	            handtype: 'right',
	            transform: {
	...
	PluginRevolutionSlider.prototype = {
		...
		build: function() {
			...
			if(this.options.addOnFilmstrip.enable) {
				RsFilmstripAddOn($, this.options.wrapper, '../plugins/rs-plugin/revolution-addons/filmstrip/', false);
			}
	...
	$.extend(theme, {
		PluginScrollToTop: {
			...
			defaults: {
				...
				// buttonClass: 'hamburguer-btn showFloatMenu',
				buttonAriaLabel: 'Scroll To Top',
				iconClass: 'fas fa-chevron-up',
				showImage: false,
				imagePath: 'images/icons/why.svg',
				imageWidth: 40,
				delay: 1000,
				visibleMobile: false,
				label: false,
			...
			build: function() {
				...
				if (self.options.showImage) {
					...
					// 設定src屬性，使用參數指定圖片路徑
					imgElement.src = self.options.imagePath;

					// 設定其他屬性（可選）
					imgElement.width = self.options.imageWidth;
					$el = $('<a />')
						.addClass(self.options.buttonClass)					
						.append(
							$(imgElement)
			...
			events: function() {
				...
				$(window).scroll(function() {
					...
					if (!_isScrolling) {
						...
						if (self.options.showImage) {
							self.$el.stop(true, true).removeClass('invisible');															
						}							
