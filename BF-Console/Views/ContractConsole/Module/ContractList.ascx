...
<table class="table table-striped nowrap dataTable-contract" style="width: 100%">
    <thead class="bg-darkteal">
        <tr>
            <th class="xl-blue col-darkteal">學生</th>
            <th>上課場所</th>
            <th>體能顧問</th>
            <th>合約編號</th>
            <th>合約名稱</th>
            ...
            <th>合約起日</th>
            <th>合約迄日</th>
            <th class="xl-blue col-darkteal">目前狀態</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td class="text-right">
                <%= ((Naming.CourseContractStatus)item.Status).ToString() %>
                <%= item.Expiration.HasValue && item.Expiration.Value<DateTime.Today ? "(*)" : null %>
...
<script>
    ...
    $(function () {
        ...
        $global.dtContract = $('.dataTable-contract').DataTable({
            ...
            //                                            '<td class="bg-darkteal col-white">'+col.title+'</td> '+
            //                                            '<td>'+col.data+'</td>'+
            //                                        '</tr>';
            //                                } ).join('');
            //         
