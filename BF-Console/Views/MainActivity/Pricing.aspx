...
<!--                    <h2 class="wow fadeInDown" data-wow-delay="0.5s">它的價值，馬上讓你看到。</h2>-->
                    <h2 class="wow fadeInDown" data-wow-delay="0.5s">南京店</h2>
                </div>
            </div>
            <div class="row clearfix">       
                <div class="col-lg-12">
                    <span class="pull-right p-r-20">
                        <a href="pricing.html" class="btn btn-simple btn-round"><i class="fas fa-exchange-alt"></i> 90</a>
                    </span>
                </div>
                <div class="col-lg-12">
                    ...
                    <%  foreach (var c in _coachData.coachItems)
                        ...
                        <div class="pricing-item">
                            <div class="pricing-deco l-slategray">
                                ...
                                <div class="pricing-price"><span class="pricing-currency">$</span>2200
                                </div>
                                <h3 class="pricing-title">單堂</h3>
                            </div>
