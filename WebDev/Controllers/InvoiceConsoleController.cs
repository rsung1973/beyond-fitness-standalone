...
namespace WebHome.Controllers
{
    ...
    public class InvoiceConsoleController : SampleController<UserProfile>
    {
        ...
        public async Task<ActionResult> CheckTurnkeyLogsAsync(InvoiceQueryViewModel viewModel)
        {
            ...
            Response.Headers.Append("Content-Disposition", String.Format("attachment;filename={0}({1:yyyy-MM-dd HH-mm-ss}).xlsx", HttpUtility.UrlEncode("IncompleteTurnkeyLogs"), DateTime.Now));
